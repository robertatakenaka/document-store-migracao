...
class TestHTML2SPSPipelineRemoveExceedingStyleTagsPipe(unittest.TestCase):
    ...
    def test_pipe_remove_exceeding_style_tags_switch_p_and_sup(self):
...
class TestCompleteFnConversionPipe(unittest.TestCase):
    def setUp(self):
        ...
        self.elements_which_have_id_ppl = ConvertElementsWhichHaveIdPipeline(
            self.html_pl
        )
        self.complete_fn_pipe = (
            self.elements_which_have_id_ppl.CompleteFnConversionPipe()
        )
    ...
    def test__move_fn_tail_into_fn__moves_italic(self):
        ...
        fn = xml.find(".//fn")
        self.assertEqual(
            fn.find("p/italic").text, "Isso é conhecido pelos pesquisadores como"
        )
    ...
    def test__move_fn_tail_into_fn__moves_items_until_p_is_found(self):
        ...
        fn = xml.find(".//fn")
        self.assertEqual(
            fn.find("p/italic").text,
            "Isso é conhecido pelos pesquisadores como"
        )
        self.assertEqual(fn.find("p/italic").tail.strip(), ".")
        self.assertEqual(fn.find("label").text, "**")
