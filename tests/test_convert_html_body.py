...
class TestHTML2SPSPipeline(unittest.TestCase):
    ...
    def test_pipe_remove_empty(self):
        text = '<root><p>texto<br/><hr/></p><p> <img align="x" src="a04qdr04.gif"/></p><p/><br/><hr/> <img align="x" src="a04qdr04.gif"/><p><b><a name="volta" id="volta"/>Colonização micorrízica e concentração de nutrientes em três cultivares de bananeiras em um latossolo amarelo da Amazônia central<sup><a href="#nota">1</a></sup></b></p> </root>'
        expected = '<root><p>texto<br/><hr/></p><p> <img align="x" src="a04qdr04.gif"/></p><br/><hr/> <img align="x" src="a04qdr04.gif"/><p><b>Colonização micorrízica e concentração de nutrientes em três cultivares de bananeiras em um latossolo amarelo da Amazônia central<sup><a href="#nota">1</a></sup></b></p> </root>'
